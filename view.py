...
#lidar com a criptografia de senhas
...
def get_receita():
    ...
    if id_usuario is None:
        return jsonify({'mensagem': 'Faça login para acessar as suas receitas'})
...
def get_despesa():
    ...
    if id_usuario is None:
        return jsonify({'mensagem': 'Faça login para acessar as suas Despesas'})
...
def get_guardar():
    ...
    if id_usuario is None:
        return jsonify({'mensagem': 'Faça login para acessar o guardar'})
...
def post_guardar():
    ...
    if id_usuario is None:
        return jsonify({'mensagem': 'Faça login para cadastrar'})
